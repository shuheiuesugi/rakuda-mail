...
export default function DemoV2() {
  ...
  const glassElevated: React.CSSProperties = {
    ...
    <div style={base}>
      ...
      <div style={{ display: "flex" }}>
            ...
            {labels.map((label, i) => (
              <div
                ...
                style={{
                  ...
                  background: activeLabel === i ? "rgba(59,130,246,0.12)" : "transparent",
                  borderRight: activeLabel === i ? "2px solid #3B82F6" : "2px solid transparent",
                  transition: "all 0.2s ease",
                  ...(activeLabel === i ? { boxShadow: "inset -20px 0 30px -20px rgba(59,130,246,0.1)" } : {}),
                }}
              >
                <span style={{ color: activeLabel === i ? "#3B82F6" : "#7a8494", filter: activeLabel === i ? "drop-shadow(0 0 4px rgba(59,130,246,0.4))" : "none" }}>
                  {labelIcons[i]}
                </span>
                <span style={{ flex: 1, fontSize: 13 }}>{label.name}</span>
                {label.count > 0 && (
                  <span style={{ fontSize: 11, color: "#3B82F6", background: "rgba(59,130,246,0.15)", padding: "2px 7px", borderRadius: 10, fontWeight: 600, boxShadow: "0 0 8px rgba(59,130,246,0.15)" }}>
                    {label.count}
                  </span>
                )}
              </div>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", height: "calc(100vh - 48px)", overflow: "hidden" }}>
          {/* Header */}
          <div style={{ padding: "12px 24px", borderBottom: "1px solid rgba(255,255,255,0.05)", backdropFilter: "blur(12px)", display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
              ...
              {emails.map((em, i) => (
                <div
                  ...
                  style={{
                    ...
                    transition: "all 0.2s ease",
                    ...(selectedEmail === i ? { boxShadow: "inset 3px 0 0 #3B82F6, inset 0 0 20px rgba(59,130,246,0.05)" } : {}),
                  }}
                >
            ...
            <div style={{ flex: 1, overflowY: "auto", padding: 24 }}>
              <div style={{ ...glass, padding: 24, marginBottom: 16, boxShadow: "0 2px 16px rgba(0,0,0,0.15)" }}>
              ...
              {/* AI Reply - Glass */}
              <div style={{ ...glassElevated, padding: 24 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
                  <span style={{ filter: "drop-shadow(0 0 4px rgba(59,130,246,0.4))" }}><SparkleIcon /></span>
                  <span style={{ fontSize: 14, fontWeight: 600 }}>AI返信ドラフト</span>
                  <span style={{ fontSize: 11, color: "#7a8494", marginLeft: 4, padding: "2px 8px", background: "rgba(59,130,246,0.1)", borderRadius: 6 }}>Beta</span>
                </div>
                  ...
                  {tones.map((tone, i) => (
                    <button
                      ...
                      style={{
                        padding: "6px 16px",
                        borderRadius: 8,
                        border: selectedTone === i ? "1px solid rgba(59,130,246,0.4)" : "1px solid rgba(255,255,255,0.06)",
                        fontSize: 12,
                        fontWeight: 500,
                        cursor: "pointer",
                        background: selectedTone === i ? "rgba(59,130,246,0.2)" : "rgba(255,255,255,0.03)",
                        color: selectedTone === i ? "#60a5fa" : "#9ca3af",
                        backdropFilter: "blur(8px)",
                        transition: "all 0.2s ease",
                        boxShadow: selectedTone === i ? "0 0 12px rgba(59,130,246,0.15)" : "none",
                      }}
                    >
                      {tone}
                    </button>
      ...
      <div style={{ padding: "64px 24px", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
        <div style={{ maxWidth: 420, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 32 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, marginBottom: 8, color: "#fff" }}>
              <WaveSvg />
            </div>
            <p style={{ fontSize: 13, color: "#7a8494" }}>AIがメール返信をサポートします</p>
          </div>
          <div style={{ ...glassElevated, padding: 32 }}>
            <button style={{
              width: "100%",
              padding: "12px 16px",
              background: "rgba(255,255,255,0.04)",
      ...
      <div style={{ padding: "48px 24px 64px", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
        <div style={{ maxWidth: 600, margin: "0 auto" }}>
          ...
          <div style={{ ...glass, padding: 24, marginBottom: 16, boxShadow: "0 2px 16px rgba(0,0,0,0.1)" }}>
          ...
          <div style={{ ...glass, padding: 24, marginBottom: 16, boxShadow: "0 2px 16px rgba(0,0,0,0.1)" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <div>
                ...
                <textarea defaultValue={"山田 太郎\n株式会社サンプル\nTel: 03-1234-5678"} rows={3} style={{
                  width: "100%", padding: "8px 12px",
                  background: "rgba(255,255,255,0.03)",
                  border: "1px solid rgba(255,255,255,0.06)",
                  borderRadius: 8, color: "#e2e8f0", fontSize: 13, outline: "none",
                  resize: "vertical", backdropFilter: "blur(8px)",
                  boxSizing: "border-box",
                }} />
              </div>
            </div>
          ...
          <div style={{ ...glass, padding: 24, boxShadow: "0 2px 16px rgba(0,0,0,0.1)" }}>
              ...
              {["新着メール通知", "AI返信提案", "週次サマリー"].map((item) => (
                <div key={item} style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  ...
                  <div style={{
                    ...
                    <div style={{ width: 18, height: 18, borderRadius: "50%", background: "#fff", position: "absolute", top: 2, right: 2, transition: "all 0.2s", boxShadow: "0 1px 3px rgba(0,0,0,0.3)" }} />
                  </div>
                </div>
              ))}
            </div>
